...
**	ClosedComponent
**
**	Not sure how to use closed components yet, will return to
*/


export class ClosedComponent extends HTMLElement {
	...
	constructor() {
		...
		this.shadowRoot.innerHTML = `				// this does *not* work
			<section>
				<slot name="heading">Closed default heading</slot>
				<p>
